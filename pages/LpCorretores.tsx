...
import LpHero from '../components/lp/corretores/LpHero';
import LpVSL from '../components/lp/corretores/LpVSL';
import LpSEO from '../components/lp/corretores/LpSEO';

const LpDor = lazy(() => import('../components/lp/corretores/LpDor'));
const LpSolucao = lazy(() => import('../components/lp/corretores/LpSolucao'));
const LpEntregamos = lazy(() => import('../components/lp/corretores/LpEntregamos'));
const LpGanhos = lazy(() => import('../components/lp/corretores/LpGanhos'));
...
const LpFAQ = lazy(() => import('../components/lp/corretores/LpFAQ'));
const LpCTA = lazy(() => import('../components/lp/corretores/LpCTA'));
        ...
        <div className="bg-[#0f152a] min-h-screen text-white font-sans selection:bg-[#3a7ad1] selection:text-white">
            ...
            <main>
                ...
                <Suspense fallback={<div className="min-h-screen flex items-center justify-center text-white/50 text-sm tracking-widest uppercase">Carregando...</div>}>
                    ...
                    <div ref={quizRef}>
                        <QuizForm source="LP Corretores" leadType="corretor" />
                    </div>
                </Suspense>
            </main>
