...
import LpHero from '../components/lp/advogados/LpHero';
import LpVSL from '../components/lp/advogados/LpVSL';
import LpSEO from '../components/lp/advogados/LpSEO';

const LpDor = lazy(() => import('../components/lp/advogados/LpDor'));
const LpSolucao = lazy(() => import('../components/lp/advogados/LpSolucao'));
const LpEntregamos = lazy(() => import('../components/lp/advogados/LpEntregamos'));
const LpGanhos = lazy(() => import('../components/lp/advogados/LpGanhos'));
...
const LpFAQ = lazy(() => import('../components/lp/advogados/LpFAQ'));
const LpCTA = lazy(() => import('../components/lp/advogados/LpCTA'));
        ...
        <div className="bg-[#0f152a] min-h-screen text-white font-sans selection:bg-[#3a7ad1] selection:text-white">
            ...
            <main>
                ...
                <Suspense fallback={<div className="min-h-screen flex items-center justify-center text-white/50 text-sm tracking-widest uppercase">Carregando...</div>}>
                    ...
                    <div ref={quizRef}>
                        <QuizForm source="LP Advogados" leadType="advogado" />
                    </div>
                </Suspense>
            </main>
