...
interface BlogPost {
  ...
  image: string; // Added based on usage in the component
  category: string; // Added based on usage in the component
  date: string; // Added based on usage in the component
  seoScore: number; // Added based on usage in the component
}
