...
const LpFAQ: React.FC = () => {
    ...
    const faqs = [
        {
            question: "Preciso de ser advogado ou ter formação em Direito para adquirir a franquia?",
            answer: "Não. Qualquer pessoa com Ensino Médio completo pode ser habilitada como Leiloeiro Oficial no Brasil. Nós entregamos todo o treino jurídico e operacional de que necessita."
        },
        {
