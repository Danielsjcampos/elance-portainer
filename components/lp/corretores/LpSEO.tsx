...
const LpSEO: React.FC = () => {
    ...
    const siteTitle = branding.site_title || branding.name || 'E-Lance | A Nova Era para Corretores de Imóveis';
    ...
    return (
        <Helmet>
            ...
            <meta name="description" content="Corretor: Pare de brigar por comissões baixas. Descubra como ingressar no mercado de leilões com a E-Lance." />

            {/* Open Graph / Facebook */}
            <meta property="og:title" content={siteTitle} />
            <meta property="og:description" content="A oportunidade definitiva para Corretores entrarem no mercado de leilões com a metodologia E-Lance." />
            ...
            <meta name="twitter:description" content="A oportunidade definitiva para Corretores entrarem no mercado de leilões com a metodologia E-Lance." />
