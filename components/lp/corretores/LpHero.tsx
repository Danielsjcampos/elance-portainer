                ...
                <div className="space-y-4">
                    ...
                    <BlurFade delay={0.4} inView>
                        <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
                            Chega de dividir a venda com outras imobiliárias, mendigar comissão e trabalhar de graça um ano resolvendo pepino de cartório e financiamento. Torne-se um Leiloeiro Oficial com exclusividade absoluta e venda imóveis com até 50% de desconto determinado pelo juiz.
                        </p>
                    </BlurFade>
                </div>
                ...
                <BlurFade delay={0.7} inView className="pt-8">
                    <RainbowButton onClick={onStartQuiz} className="text-base font-bold w-full sm:w-auto mt-4 px-12 py-6">
                        <span className="relative flex items-center">
                            Quero ser um Corretor de Elite
