            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10 text-center">
                <BlurFade delay={0.1} inView>
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 leading-tight">
                        Está na hora de colocar o seu networking comercial a render num oceano azul.
                    </h2>

                    <p className="text-xl text-blue-100/90 mb-12 max-w-3xl mx-auto leading-relaxed">
                        Dê o primeiro passo rumo à elite do mercado imobiliário: torne-se um Leiloeiro Oficial e dono de uma franquia E-Lance. As concessões por região são exclusivas.
                    </p>

                    <RainbowButton variant="light" onClick={onStartQuiz} className="text-lg font-bold w-full sm:w-auto px-12 py-6">
                        <span className="relative flex items-center">
                            Quero ser Leiloeiro Oficial
