...
const LpFAQ: React.FC = () => {
    ...
    const faqs = [
        {
            question: "Preciso ter CRECI ativo para ser Leiloeiro Oficial?",
            answer: "Não. O mercado de corretagem (CRECI) foca em transações entre particulares. O Leiloeiro Oficial precisa de registro na Junta Comercial. Pode atuar em ambos ou migrar de vez, e nós ajudamos em toda a parte burocrática."
        },
        {
