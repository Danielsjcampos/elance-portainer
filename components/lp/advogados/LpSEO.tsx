...
const LpSEO: React.FC = () => {
    ...
    const siteTitle = branding.site_title || branding.name || 'E-Lance | Honorários Previsíveis para Advogados';
    ...
    return (
        <Helmet>
            ...
            <meta name="description" content="Advogado: Transforme seu escritório com honorários mais rápidos através dos Leilões Extrajudiciais e Judiciais. Conheça a E-Lance." />

            {/* Open Graph / Facebook */}
            <meta property="og:title" content={siteTitle} />
            <meta property="og:description" content="A oportunidade definitiva para Advogados faturarem alto no mercado de leilões." />
            ...
            <meta name="twitter:description" content="A oportunidade definitiva para Advogados faturarem alto no mercado de leilões." />
