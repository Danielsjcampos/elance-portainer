                        ...
                        {isPlaying ? (
                            ...
                            >
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/90 to-transparent z-20 text-left">
                                    <p className="text-white font-bold text-xl mb-1">Honorários Sem Morosidade</p>
                                    <p className="text-gray-300 text-sm md:text-base">Entenda o modelo de negócio para Advogados de Alta Renda</p>
                                </div>
                            </button>
                        )}
                    </div>
