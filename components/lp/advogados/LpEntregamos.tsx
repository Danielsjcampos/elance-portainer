                    ...
                    <BlurFade delay={0.4} inView>
                        ...
                        <div className="group relative rounded-2xl overflow-hidden h-full flex flex-col justify-end p-8 border border-white/10 aspect-[3/4] md:aspect-auto md:min-h-[420px]">
                            ...
                            <div className="relative z-20">
                                ...
                                <p className="text-gray-300 leading-relaxed">
                                    Aprenda a monetizar seu conhecimento de leis. O nosso Centro leva você à atuação como Leiloeiro Oficial ou Assessor de Arrematantes com excelência e segurança.
                                </p>
                            </div>
                        </div>
                    </BlurFade>
                    ...
                    <BlurFade delay={0.6} inView>
                        ...
                        <div className="group relative rounded-2xl overflow-hidden h-full flex flex-col justify-end p-8 border border-white/10 aspect-[3/4] md:aspect-auto md:min-h-[420px]">
                            ...
                            <div className="relative z-20">
                                ...
                                <p className="text-gray-300 leading-relaxed">
                                    Modelos de editais, arrematações, manuais de gestão e ferramentas inteligentes para poupar seu tempo com novas petições e focar no que gera receita.
                                </p>
                            </div>
                        </div>
                    </BlurFade>
