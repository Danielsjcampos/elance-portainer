                ...
                <BlurFade delay={0.1} inView>
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
                            Honorários Escaláveis: <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3a7ad1] to-blue-400">A Regra dos 5%</span>
                        </h2>
                        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                            Como Assessor ou Leiloeiro Oficial, a métrica de lucro no leilão é monumental comparada aos honorários contratuais de praxe ou sucumbência. Veja a diferença:
                        </p>
                    </div>
                </BlurFade>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                    <BlurFade delay={0.3} inView>
                        ...
                        <div className="bg-[#151d38] border border-white/10 rounded-2xl p-8 relative group hover:border-[#3a7ad1]/40 transition-colors h-full">
                            ...
                            <h3 className="text-lg font-medium text-gray-400 mb-2">Arrematação Judicial (Imóvel Médio)</h3>
                    ...
                    <BlurFade delay={0.5} inView>
                        ...
                        <div className="bg-[#151d38] border border-white/10 rounded-2xl p-8 relative group hover:border-[#3a7ad1]/40 transition-colors h-full">
                            ...
                            <h3 className="text-lg font-medium text-gray-400 mb-2">Massa Falida / Imóvel Comercial</h3>
                    ...
                    <div className="bg-gradient-to-r from-[#3a7ad1]/20 to-transparent p-1 rounded-2xl mt-8">
                        <div className="bg-[#0b0f1e] rounded-xl p-8 text-center flex flex-col md:flex-row items-center justify-center gap-4">
                            ...
                            <p className="text-xl md:text-2xl font-semibold text-white">
                                "Quantos anos um inventário padrão precisa rolar no judiciário para gerar <span className="text-[#3a7ad1]">100 mil em honorários</span>?"
                            </p>
                        </div>
                    </div>
                </BlurFade>
