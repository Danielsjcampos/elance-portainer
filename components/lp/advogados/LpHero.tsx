                ...
                <div className="space-y-4">
                    ...
                    <BlurFade delay={0.4} inView>
                        <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
                            Chega de depender da morosidade judiciária. Use seu conhecimento para se tornar um Leiloeiro Oficial ou Assessorar grandes investidores com nossa tecnologia e suporte completo.
                        </p>
                    </BlurFade>
                </div>
