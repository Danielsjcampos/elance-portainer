                ...
                <BlurFade delay={0.1} inView>
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                            No mercado de leilões, a regra é clara: o Leiloeiro Oficial tem direito a 5% de comissão sobre o valor do bem arrematado. Veja o potencial do seu novo negócio:
                        </p>
                    </div>
                </BlurFade>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                    <BlurFade delay={0.3} inView>
                        ...
                        <div className="bg-[#151d38] border border-white/10 rounded-2xl p-8 relative group hover:border-[#3a7ad1]/40 transition-colors h-full">
                            ...
                            <h3 className="text-lg font-medium text-gray-400 mb-2">Venda de 1 imóvel médio</h3>
                    ...
                    <BlurFade delay={0.5} inView>
                        ...
                        <div className="bg-[#151d38] border border-white/10 rounded-2xl p-8 relative group hover:border-[#3a7ad1]/40 transition-colors h-full">
                            ...
                            <h3 className="text-lg font-medium text-gray-400 mb-2">Venda de 1 imóvel de luxo/galpão</h3>
                    ...
                    <div className="bg-gradient-to-r from-[#3a7ad1]/20 to-transparent p-1 rounded-2xl mt-8">
                        <div className="bg-[#0b0f1e] rounded-xl p-8 text-center flex flex-col md:flex-row items-center justify-center gap-4">
                            ...
                            <p className="text-xl md:text-2xl font-semibold text-white">
                                "Quantos negócios tradicionais precisam de vender <span className="text-[#3a7ad1]">milhares de produtos</span> para alcançar este lucro líquido?"
                            </p>
                        </div>
                    </div>
                </BlurFade>
